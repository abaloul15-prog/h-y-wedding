  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative mx-auto max-w-6xl sm:px-6 md:px-8"
      >
        <div
          aria-hidden
        ...
        <div
          className={`relative overflow-hidden shadow-[0_40px_120px_-20px_rgba(0,0,0,0.8)] ring-1 ring-champagne/10 sm:rounded-2xl md:rounded-3xl ${
            isPortrait
              ? "mx-auto aspect-[9/16] w-full sm:w-[min(100%,calc(80dvh*(9/16)))]"
              : "aspect-video"
          }`}
        >
        ...
        <p className="mx-auto mt-8 max-w-2xl px-6 text-center font-body text-sm leading-relaxed text-ivory/60 sm:px-0 md:text-base">
          {video.description}
        </p>
      </motion.div>
    </section>
